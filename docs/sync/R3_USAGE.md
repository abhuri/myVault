...
| `R3.3` | GPT-5.6 Sol High ค่ะ | GPT-5.6 Terra High ใช้ได้เฉพาะ bounded adapter/tests หลัง provider contract freeze ค่ะ | Gemini 3.5 Flash (High) สำหรับ second opinion จาก allowlisted official excerpts ค่ะ | Exact-ID Drive mutation, stale revision และ lost-response reconciliation ค่ะ |
