...
R3.2, R3.3 block-enforcement และ R3.4 ทำคู่ขนานได้หลัง R3.1 contract freeze ค่ะ
R3.5 เป็นต้นไปหยุด parallel source edits และให้ main integrator เป็นเจ้าของ
