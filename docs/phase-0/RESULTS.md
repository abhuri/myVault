...
Updated 2026-07-11 22:32 Asia/Bangkokค่ะ
...
| Cross-platform Build | PARTIAL | macOS native debug build, Ubuntu quality CI, Android ARM64 APK, 16 KB APK alignment, and API 36 emulator launch passค่ะ | The manual native build workflow must produce Windows NSIS and Ubuntu 22.04 AppImage artifactsค่ะ |
...
Phase 0 cannot honestly reach final `PASS` without both of the followingค่ะ

1. A Google Cloud project with Drive API enabled and Android/Desktop OAuth clients configuredค่ะ
2. A physical Android device connected for Play Services consent and Thai IME testingค่ะ
