...
- ไม่มี active implementation milestone ค่ะ R3 — Mutations + Conflict Safety
  ยัง Locked planned รอ transition approval แยกต่างหากค่ะ
...
1. คง R3 เป็น Locked planned และห้ามเริ่ม rename/move/Trash/conflict work จนกว่า
   คุณโอจะอนุมัติ transition plan ใหม่ค่ะ
2. หากเปิด R3 ให้เริ่มด้วย scope, mutation safety contract, acceptance gates และ
   approval plan แยกต่างหากค่ะ
3. รักษา R2 evidence เป็น historical completion record และห้ามใช้ emulator/CI
