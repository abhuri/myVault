...
1. Review Draft PR #28 ซึ่งรวม R2 closure + R3 planning diff และยืนยันว่าไม่มี
   source implementation หรือ scope drift ค่ะ
2. ให้ Draft PR #28 ผ่าน review/CI แล้วขอ approval แยกก่อน merge เข้า canonical
   `main` ค่ะ
