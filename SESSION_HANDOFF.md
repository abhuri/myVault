...
- Canonical branch คือ `main` และ R3.0 contract checkpoint คือ merge commit
  `eb6709c` จาก PR #28 ค่ะ
...
1. ขอ explicit `Approve R3 transition` เพื่อเปิด R3 implementation milestone ค่ะ
2. เริ่ม R3.1 source implementation ได้หลัง transition approval เท่านั้นค่ะ
3. Exact disposable account/root fingerprints ต้องได้รับ approval ก่อน R3.6 live
   R1/R2 regression และห้ามบันทึก credential/personal path ค่ะ
4. รักษา R2 evidence เป็น historical completion record และห้ามใช้ emulator/CI
